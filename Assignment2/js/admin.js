...
var Admin = (function() {
    ...
    function makeScoreFields(parent, key, match) {
        ...
        parent.append("<input type='hidden' name='"+ name + "' value ='"+match.team1+"'>");
        parent.append("<input type='number' name='" + id + "' id ='" + id + "' value='" + match.score1 + "'>");
        id = "team2_" + key;
        name = "team2name_"+key;
        parent.append("<label for='" + id + "'>" + match.team2 + ": </label>");
        parent.append("<input type='hidden' name='"+ name + "' value ='"+match.team2+"'>");
    ...
    function displayAdmin() {
        ...
        adminForm.append("<input type='submit' value='Update Schedule' name='submit'>");
        //adminForm.on("submit", validateForm);
    }
